...
public class LoginViewModelTests
{
    ...
    private de.vimotest.examples.loginview.LoginViewModelTestEnvironment testEnvironment;

    [Microsoft.VisualStudio.TestTools.UnitTesting.TestInitialize]
    public void SetUp()
    {
        this.testEnvironment = new de.vimotest.examples.loginview.LoginViewModelTestEnvironmentImpl();

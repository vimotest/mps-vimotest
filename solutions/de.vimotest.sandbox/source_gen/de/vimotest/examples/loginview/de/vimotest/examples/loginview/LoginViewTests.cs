...
{
    private de.vimotest.examples.loginview.LoginView sut;
 
    private de.vimotest.examples.loginview.LoginViewTestSetup testSetup;
 
  [ Microsoft.VisualStudio.TestTools.UnitTesting.TestInitialize]
  public void SetUp()
  {
    this.testSetup = new de.vimotest.examples.loginview.LoginViewTestSetupImpl();
    this.testSetup.Init();
  }

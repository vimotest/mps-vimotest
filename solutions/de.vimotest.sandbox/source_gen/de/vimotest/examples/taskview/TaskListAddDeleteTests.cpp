...
void TaskListAddDeleteTests::when_LoadView1( ) 
{
  this->sut->loadView();
}
...
void TaskListAddDeleteTests::when_LoadView2( ) 
{
  this->sut->loadView();
}
...
void TaskListAddDeleteTests::when_click_DeleteTask1( ) 
{
  this->sut->deleteTaskClicked();
}

void TaskListAddDeleteTests::when_LoadView3( ) 
{
  this->sut->loadView();
}
...
void TaskListAddDeleteTests::when_click_DeleteTask2( ) 
{
  this->sut->deleteTaskClicked();
}

void TaskListAddDeleteTests::when_LoadView4( ) 
{
  this->sut->loadView();
}

void TaskListAddDeleteTests::when_click_DeleteTask3( ) 
{
  this->sut->deleteTaskClicked();
}

void TaskListAddDeleteTests::when_click_DeleteTask4( ) 
{
  this->sut->deleteTaskClicked();
}

void TaskListAddDeleteTests::when_click_DeleteTask5( ) 
{
  this->sut->deleteTaskClicked();
}

void TaskListAddDeleteTests::when_LoadView5( ) 
{
  this->sut->loadView();
}

void TaskListAddDeleteTests::when_select_row_0_in_Tasks1( ) 
{
  this->sut->tasksRowSelected(std::string("0"));
}

void TaskListAddDeleteTests::when_click_DeleteTask6( ) 
{
  this->sut->deleteTaskClicked();
}
...
void TaskListAddDeleteTests::then_Tasks_has_2_rows_and_selected_row_handle_11( ) 
{
  auto& actualRows = this->sut->getTasksWidgetTableRows();
  EXPECT_EQ(2, actualRows.size());
  // {
...
void TaskListAddDeleteTests::then_Tasks_has_2_rows_and_selected_row_handle_12( ) 
{
  auto& actualRows = this->sut->getTasksWidgetTableRows();
  EXPECT_EQ(2, actualRows.size());
  // {

...
public class SelectRowCommand_ViewTests_Test {
  ...
  public void then_MyListViewElements_has_2_rows() {
    ...
    Assert.assertEquals("Expected that list view MyListViewElements row at index 0 has rowhandle <0>, but was <" + IntegerFunctions.ToString(row0.getRowIndex()) + ">", Integer.valueOf(row0.getRowIndex()), row0.getRowIndex());
    ...
    Assert.assertEquals("Expected that list view MyListViewElements row at index 1 has rowhandle <1>, but was <" + IntegerFunctions.ToString(row1.getRowIndex()) + ">", Integer.valueOf(row1.getRowIndex()), row1.getRowIndex());
  ...
  public void then_MyTableViewElements_has_2_rows() {
    ...
    Assert.assertEquals("Expected that table view MyTableViewElements row at index 0 has rowhandle <0>, but was <" + IntegerFunctions.ToString(row0.getRowIndex()) + ">", Integer.valueOf(row0.getRowIndex()), row0.getRowIndex());
    ...
    Assert.assertEquals("Expected that table view MyTableViewElements row at index 1 has rowhandle <1>, but was <" + IntegerFunctions.ToString(row1.getRowIndex()) + ">", Integer.valueOf(row1.getRowIndex()), row1.getRowIndex());
  ...
  public void then_MyTreeViewElements_has_2_rows() {
    ...
    Assert.assertEquals("Expected that tree view MyTreeViewElements row at index 1 has parent rowhandle <" + IntegerFunctions.ToString(0) + ">, but was <" + IntegerFunctions.ToString(row1.getRowDepth()) + ">", Integer.valueOf(row1.getRowDepth()), row1.getRowDepth());
    Assert.assertEquals("Expected that label columnCell has text <" + "B" + ">, but was <" + row1.getColumnCellLabelText() + ">", "B", row1.getColumnCellLabelText());
    // }
  }
  public void then_MyStringRowHandleTreeViewElements_has_2_rows() {
    ...
    Assert.assertEquals("Expected that tree view MyStringRowHandleTreeViewElements row at index 0 has parent rowhandle <" + IntegerFunctions.ToString(0) + ">, but was <" + IntegerFunctions.ToString(row0.getRowDepth()) + ">", Integer.valueOf(row0.getRowDepth()), row0.getRowDepth());
    Assert.assertEquals("Expected that label columnCell has text <" + "A" + ">, but was <" + row0.getColumnCellLabelText() + ">", "A", row0.getColumnCellLabelText());
    // }
    // {
    ...
    Assert.assertEquals("Expected that tree view MyStringRowHandleTreeViewElements row at index 1 has parent rowhandle <" + IntegerFunctions.ToString(0) + ">, but was <" + IntegerFunctions.ToString(row1.getRowDepth()) + ">", Integer.valueOf(row1.getRowDepth()), row1.getRowDepth());
    Assert.assertEquals("Expected that label columnCell has text <" + "B" + ">, but was <" + row1.getColumnCellLabelText() + ">", "B", row1.getColumnCellLabelText());
    // }
  }

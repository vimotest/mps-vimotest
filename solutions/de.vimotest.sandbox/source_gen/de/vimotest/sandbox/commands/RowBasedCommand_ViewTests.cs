...
public class RowBasedCommand_ViewTests
{
    ...
    public virtual void then_MyFlags_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that list view MyFlags has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that list view MyFlags row at index 0 has rowhandle <0>, but was <" + Convert.ToString(row0.getRowIndex()) + ">");
...

        {
            ...
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that list view MyFlags row at index 1 has rowhandle <1>, but was <" + Convert.ToString(row1.getRowIndex()) + ">");
    ...
    public virtual void then_MyComboBoxes_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that table view MyComboBoxes has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that table view MyComboBoxes row at index 0 has rowhandle <0>, but was <" + Convert.ToString(row0.getRowIndex()) + ">");
            var actualRow0FreeTextComboBoxesEntries = row0.getFreeTextComboBoxesComboBoxEntries();
            Assert.AreEqual(0, actualRow0FreeTextComboBoxesEntries.Count, "Expected that combobox FreeTextComboBoxes has 0 entries, but has " + Convert.ToString(actualRow0FreeTextComboBoxesEntries.Count));
            ...
            Assert.AreEqual(3, actualRow0EntryComboBoxesEntries.Count, "Expected that combobox EntryComboBoxes has 3 entries, but has " + Convert.ToString(actualRow0EntryComboBoxesEntries.Count));
        ...
        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that table view MyComboBoxes row at index 1 has rowhandle <1>, but was <" + Convert.ToString(row1.getRowIndex()) + ">");
            var actualRow1FreeTextComboBoxesEntries = row1.getFreeTextComboBoxesComboBoxEntries();
            Assert.AreEqual(0, actualRow1FreeTextComboBoxesEntries.Count, "Expected that combobox FreeTextComboBoxes has 0 entries, but has " + Convert.ToString(actualRow1FreeTextComboBoxesEntries.Count));
            ...
            Assert.AreEqual(3, actualRow1EntryComboBoxesEntries.Count, "Expected that combobox EntryComboBoxes has 3 entries, but has " + Convert.ToString(actualRow1EntryComboBoxesEntries.Count));
    ...
    public virtual void then_MyStandardControls_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that tree view MyStandardControls has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that tree view MyStandardControls row at index 0 has rowhandle <0>, but was <" + Convert.ToString(row0.getRowIndex()) + ">");
            Assert.AreEqual(0, row0.getRowDepth(), "Expected that tree view MyStandardControls row at index 0 has parent rowhandle <" + Convert.ToString(0) + ">, but was <" + Convert.ToString(row0.getRowDepth()) + ">");
        ...
        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that tree view MyStandardControls row at index 1 has rowhandle <1>, but was <" + Convert.ToString(row1.getRowIndex()) + ">");
            Assert.AreEqual(0, row1.getRowDepth(), "Expected that tree view MyStandardControls row at index 1 has parent rowhandle <" + Convert.ToString(0) + ">, but was <" + Convert.ToString(row1.getRowDepth()) + ">");

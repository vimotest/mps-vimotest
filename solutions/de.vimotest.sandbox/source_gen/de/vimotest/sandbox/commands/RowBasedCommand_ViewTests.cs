...
public class RowBasedCommand_ViewTests
{
    ...
    public virtual void then_MyFlags_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that list view MyFlags has 2 rows, but has " + IntegerFunctions.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that list view MyFlags row at index 0 has rowhandle <0>, but was <" + IntegerFunctions.ToString(row0.getRowIndex()) + ">");
            Assert.IsTrue(row0.getIsCheckboxesCheckBoxChecked(), "Expected that checkbox Checkboxes is checked, but was <" + (row0.getIsCheckboxesCheckBoxChecked() ? "checked" : "unchecked") + ">");
        }

        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that list view MyFlags row at index 1 has rowhandle <1>, but was <" + IntegerFunctions.ToString(row1.getRowIndex()) + ">");
            Assert.IsFalse(row1.getIsCheckboxesCheckBoxChecked(), "Expected that checkbox Checkboxes is unchecked, but was <" + (row1.getIsCheckboxesCheckBoxChecked() ? "checked" : "unchecked") + ">");
        }
    }
    ...
    public virtual void then_MyComboBoxes_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that table view MyComboBoxes has 2 rows, but has " + IntegerFunctions.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that table view MyComboBoxes row at index 0 has rowhandle <0>, but was <" + IntegerFunctions.ToString(row0.getRowIndex()) + ">");
            var actualRow0FreeTextComboBoxesEntries = row0.getFreeTextComboBoxesComboBoxEntries();
            Assert.AreEqual(0, actualRow0FreeTextComboBoxesEntries.Count, "Expected that combobox FreeTextComboBoxes has 0 entries, but has " + IntegerFunctions.ToString(actualRow0FreeTextComboBoxesEntries.Count));
            Assert.AreEqual("", row0.getFreeTextComboBoxesComboBoxSelectedEntry(), "Expected that combobox FreeTextComboBoxes has " + "no selection" + ", but was <" + row0.getFreeTextComboBoxesComboBoxSelectedEntry() + ">");
            ...
            Assert.AreEqual(3, actualRow0EntryComboBoxesEntries.Count, "Expected that combobox EntryComboBoxes has 3 entries, but has " + IntegerFunctions.ToString(actualRow0EntryComboBoxesEntries.Count));
            ...
            Assert.AreEqual("", row0.getEntryComboBoxesComboBoxSelectedEntry(), "Expected that combobox EntryComboBoxes has " + "no selection" + ", but was <" + row0.getEntryComboBoxesComboBoxSelectedEntry() + ">");
        }

        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that table view MyComboBoxes row at index 1 has rowhandle <1>, but was <" + IntegerFunctions.ToString(row1.getRowIndex()) + ">");
            var actualRow1FreeTextComboBoxesEntries = row1.getFreeTextComboBoxesComboBoxEntries();
            Assert.AreEqual(0, actualRow1FreeTextComboBoxesEntries.Count, "Expected that combobox FreeTextComboBoxes has 0 entries, but has " + IntegerFunctions.ToString(actualRow1FreeTextComboBoxesEntries.Count));
            Assert.AreEqual("", row1.getFreeTextComboBoxesComboBoxSelectedEntry(), "Expected that combobox FreeTextComboBoxes has " + "no selection" + ", but was <" + row1.getFreeTextComboBoxesComboBoxSelectedEntry() + ">");
            ...
            Assert.AreEqual(3, actualRow1EntryComboBoxesEntries.Count, "Expected that combobox EntryComboBoxes has 3 entries, but has " + IntegerFunctions.ToString(actualRow1EntryComboBoxesEntries.Count));
            ...
            Assert.AreEqual("", row1.getEntryComboBoxesComboBoxSelectedEntry(), "Expected that combobox EntryComboBoxes has " + "no selection" + ", but was <" + row1.getEntryComboBoxesComboBoxSelectedEntry() + ">");
        }
    }
    ...
    public virtual void then_MyStandardControls_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that tree view MyStandardControls has 2 rows, but has " + IntegerFunctions.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that tree view MyStandardControls row at index 0 has rowhandle <0>, but was <" + IntegerFunctions.ToString(row0.getRowIndex()) + ">");
            Assert.AreEqual(0, row0.getRowDepth(), "Expected that tree view MyStandardControls row at index 0 has parent rowhandle <" + IntegerFunctions.ToString(0) + ">, but was <" + IntegerFunctions.ToString(row0.getRowDepth()) + ">");
        ...
        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that tree view MyStandardControls row at index 1 has rowhandle <1>, but was <" + IntegerFunctions.ToString(row1.getRowIndex()) + ">");
            Assert.AreEqual(0, row1.getRowDepth(), "Expected that tree view MyStandardControls row at index 1 has parent rowhandle <" + IntegerFunctions.ToString(0) + ">, but was <" + IntegerFunctions.ToString(row1.getRowDepth()) + ">");

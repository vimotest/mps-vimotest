...
public class SelectEntryCommand_ViewTests
{
   ...
   */
    ...
    public virtual void then_MyElements_has_3_entries_and()
    {
        ...
        Assert.AreEqual("", this.sut.getMyElementsComboBoxSelectedEntry(), "Expected that combobox MyElements has " + "no selection" + ", but was <" + this.sut.getMyElementsComboBoxSelectedEntry() + ">");
    }
}

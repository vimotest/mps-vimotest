...
namespace commands
{
  ...
  void SelectRowCommand_ViewTests::then_MyListViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(2, actualRows.size()) << std::string("Expected that list view MyListViewElements has 2 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);
    EXPECT_EQ(0, row0->getRowIndex()) << std::string("Expected that list view MyListViewElements row at index 0 has rowhandle <0>, but was <") + std::to_string(row0->getRowIndex()) + std::string(">");
    ...
    EXPECT_EQ(1, row1->getRowIndex()) << std::string("Expected that list view MyListViewElements row at index 1 has rowhandle <1>, but was <") + std::to_string(row1->getRowIndex()) + std::string(">");
  ...
  void SelectRowCommand_ViewTests::then_MyStringRowHandleListViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(2, actualRows.size()) << std::string("Expected that list view MyStringRowHandleListViewElements has 2 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);
  ...
  void SelectRowCommand_ViewTests::then_MyTableViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(2, actualRows.size()) << std::string("Expected that table view MyTableViewElements has 2 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);
    EXPECT_EQ(0, row0->getRowIndex()) << std::string("Expected that table view MyTableViewElements row at index 0 has rowhandle <0>, but was <") + std::to_string(row0->getRowIndex()) + std::string(">");
    ...
    // {
    auto& row1 = actualRows.at(1);
    EXPECT_EQ(1, row1->getRowIndex()) << std::string("Expected that table view MyTableViewElements row at index 1 has rowhandle <1>, but was <") + std::to_string(row1->getRowIndex()) + std::string(">");
  ...
  void SelectRowCommand_ViewTests::then_MyStringRowHandleTableViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(2, actualRows.size()) << std::string("Expected that table view MyStringRowHandleTableViewElements has 2 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);
  ...
  void SelectRowCommand_ViewTests::then_MyTreeViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(0, row1->getRowDepth()) << std::string("Expected that tree view MyTreeViewElements row at index 1 has parent rowhandle <") + std::to_string(0) + std::string(">, but was <") + std::to_string(row1->getRowDepth()) + std::string(">");
    EXPECT_EQ(std::string("B"), row1->getColumnCellLabelText()) << std::string("Expected that label columnCell has text <") + std::string("B") + std::string(">, but was <") + row1->getColumnCellLabelText() + std::string(">");
    // }
  }
  void SelectRowCommand_ViewTests::then_MyStringRowHandleTreeViewElements_has_2_rows()
  {
    ...
    EXPECT_EQ(2, actualRows.size()) << std::string("Expected that tree view MyStringRowHandleTreeViewElements has 2 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);
    ...
    EXPECT_EQ(0, row0->getRowDepth()) << std::string("Expected that tree view MyStringRowHandleTreeViewElements row at index 0 has parent rowhandle <") + std::to_string(0) + std::string(">, but was <") + std::to_string(row0->getRowDepth()) + std::string(">");
    EXPECT_EQ(std::string("A"), row0->getColumnCellLabelText()) << std::string("Expected that label columnCell has text <") + std::string("A") + std::string(">, but was <") + row0->getColumnCellLabelText() + std::string(">");
    // }
    // {
    auto& row1 = actualRows.at(1);
    ...
    EXPECT_EQ(0, row1->getRowDepth()) << std::string("Expected that tree view MyStringRowHandleTreeViewElements row at index 1 has parent rowhandle <") + std::to_string(0) + std::string(">, but was <") + std::to_string(row1->getRowDepth()) + std::string(">");
    EXPECT_EQ(std::string("B"), row1->getColumnCellLabelText()) << std::string("Expected that label columnCell has text <") + std::string("B") + std::string(">, but was <") + row1->getColumnCellLabelText() + std::string(">");
    // }
  }
  void SelectRowCommand_ViewTests::then_MyStringHandleMultiSelectRowListViewElements_has_3_rows()
  {
    ...
    EXPECT_EQ(3, actualRows.size()) << std::string("Expected that list view MyStringHandleMultiSelectRowListViewElements has 3 rows, but has ") + std::to_string(actualRows.size());
    // {
    auto& row0 = actualRows.at(0);

...
public class SelectRowCommand_ViewTests
{
    ...
    public virtual void then_MyListViewElements_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that list view MyListViewElements has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that list view MyListViewElements row at index 0 has rowhandle <0>, but was <" + Convert.ToString(row0.getRowIndex()) + ">");
...

        {
            ...
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that list view MyListViewElements row at index 1 has rowhandle <1>, but was <" + Convert.ToString(row1.getRowIndex()) + ">");
    ...
    public virtual void then_MyStringRowHandleListViewElements_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that list view MyStringRowHandleListViewElements has 2 rows, but has " + Convert.ToString(actualRows.Count));
    ...
    public virtual void then_MyTableViewElements_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that table view MyTableViewElements has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            var row0 = actualRows[0];
            Assert.AreEqual(0, row0.getRowIndex(), "Expected that table view MyTableViewElements row at index 0 has rowhandle <0>, but was <" + Convert.ToString(row0.getRowIndex()) + ">");
        ...
        {
            var row1 = actualRows[1];
            Assert.AreEqual(1, row1.getRowIndex(), "Expected that table view MyTableViewElements row at index 1 has rowhandle <1>, but was <" + Convert.ToString(row1.getRowIndex()) + ">");
    ...
    public virtual void then_MyStringRowHandleTableViewElements_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that table view MyStringRowHandleTableViewElements has 2 rows, but has " + Convert.ToString(actualRows.Count));
    ...
    public virtual void then_MyTreeViewElements_has_2_rows()
    {
...

        {
            ...
            Assert.AreEqual(0, row1.getRowDepth(), "Expected that tree view MyTreeViewElements row at index 1 has parent rowhandle <" + Convert.ToString(0) + ">, but was <" + Convert.ToString(row1.getRowDepth()) + ">");
            Assert.AreEqual("B", row1.getColumnCellLabelText(), "Expected that label columnCell has text <" + "B" + ">, but was <" + row1.getColumnCellLabelText() + ">");
        }
    }
    ...
    public virtual void then_MyStringRowHandleTreeViewElements_has_2_rows()
    {
        ...
        Assert.AreEqual(2, actualRows.Count, "Expected that tree view MyStringRowHandleTreeViewElements has 2 rows, but has " + Convert.ToString(actualRows.Count));

        {
            ...
            Assert.AreEqual(0, row0.getRowDepth(), "Expected that tree view MyStringRowHandleTreeViewElements row at index 0 has parent rowhandle <" + Convert.ToString(0) + ">, but was <" + Convert.ToString(row0.getRowDepth()) + ">");
            Assert.AreEqual("A", row0.getColumnCellLabelText(), "Expected that label columnCell has text <" + "A" + ">, but was <" + row0.getColumnCellLabelText() + ">");
        }

        {
            ...
            Assert.AreEqual(0, row1.getRowDepth(), "Expected that tree view MyStringRowHandleTreeViewElements row at index 1 has parent rowhandle <" + Convert.ToString(0) + ">, but was <" + Convert.ToString(row1.getRowDepth()) + ">");
            Assert.AreEqual("B", row1.getColumnCellLabelText(), "Expected that label columnCell has text <" + "B" + ">, but was <" + row1.getColumnCellLabelText() + ">");
        }
    }
    ...
    public virtual void then_MyStringHandleMultiSelectRowListViewElements_has_3_rows()
    {
        ...
        Assert.AreEqual(3, actualRows.Count, "Expected that list view MyStringHandleMultiSelectRowListViewElements has 3 rows, but has " + Convert.ToString(actualRows.Count));

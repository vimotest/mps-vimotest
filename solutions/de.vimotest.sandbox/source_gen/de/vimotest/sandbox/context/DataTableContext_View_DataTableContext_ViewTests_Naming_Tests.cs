/// <filename>
///     DataTableContext_View_DataTableContext_ViewTests_Naming_Tests.cs
/// </filename>
using context;
using Microsoft.VisualStudio.TestTools.UnitTesting;

[ Microsoft.VisualStudio.TestTools.UnitTesting.TestClass]
public class DataTableContext_View_DataTableContext_ViewTests_Naming_Tests
{
    private context.DataTableContext_View sut;
 
    private context.DataTableContext_ViewTestSetup testSetup;
 
  [ Microsoft.VisualStudio.TestTools.UnitTesting.TestInitialize]
  public void SetUp()
  {
    this.testSetup = new context.DataTableContext_ViewTestSetupImpl();
    this.testSetup.Init();
  }

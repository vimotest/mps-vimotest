/// <filename>
///     ViewDependencyViewModelTestEnvironmentImpl.cs
/// </filename>
using dependencies;

namespace dependencies
{
    public class ViewDependencyViewModelTestEnvironmentImpl : dependencies.ViewDependencyViewModelTestEnvironment
    {

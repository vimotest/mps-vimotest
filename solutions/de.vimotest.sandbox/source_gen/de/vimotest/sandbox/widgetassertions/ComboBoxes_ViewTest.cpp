...
namespace widgetassertions
{
  ...
  void ComboBoxes_ViewTest::then_MyOptions_has_3_entries_and_selected_A1_and_is_enabled_and_is_visible()
  {
    ...
    ASSERT_EQ(3, actualMyOptionsEntries.size()) << std::string("Expected that combobox MyOptions has 3 entries, but has ") + std::to_string(actualMyOptionsEntries.size());
    ASSERT_EQ(std::string("A1"), actualMyOptionsEntries.at(0)) << std::string("Expected that combobox MyOptions has entry at index 0 matching <") + std::string("A1") + std::string(">, but was <") + actualMyOptionsEntries.at(0) + std::string(">");
  ...
  void ComboBoxes_ViewTest::then_MyOptionsWithFreeText_has_2_entries_and_and_shows_text_My_Free_Text_()
  {
    ...
    ASSERT_EQ(2, actualMyOptionsWithFreeTextEntries.size()) << std::string("Expected that combobox MyOptionsWithFreeText has 2 entries, but has ") + std::to_string(actualMyOptionsWithFreeTextEntries.size());
    ASSERT_EQ(std::string("E1"), actualMyOptionsWithFreeTextEntries.at(0)) << std::string("Expected that combobox MyOptionsWithFreeText has entry at index 0 matching <") + std::string("E1") + std::string(">, but was <") + actualMyOptionsWithFreeTextEntries.at(0) + std::string(">");
    ASSERT_EQ(std::string("E2"), actualMyOptionsWithFreeTextEntries.at(1)) << std::string("Expected that combobox MyOptionsWithFreeText has entry at index 1 matching <") + std::string("E2") + std::string(">, but was <") + actualMyOptionsWithFreeTextEntries.at(1) + std::string(">");
    ASSERT_EQ(nullptr, this->sut->getMyOptionsWithFreeTextComboBoxSelectedEntry()) << std::string("Expected that combobox MyOptionsWithFreeText has ") + std::string("no selection") + std::string(", but was <") + this->sut->getMyOptionsWithFreeTextComboBoxSelectedEntry() + std::string(">");
    ASSERT_EQ(std::string("My Free Text"), this->sut->getMyOptionsWithFreeTextComboBoxText()) << std::string("Expected that combobox MyOptionsWithFreeText has text <") + std::string("My Free Text") + std::string(">, but was <") + this->sut->getMyOptionsWithFreeTextComboBoxText() + std::string(">");
  }
  void ComboBoxes_ViewTest::then_MyOptions_has_1_entries_and_selected_A_and_is_not_enabled()
  {
    ...
    ASSERT_EQ(1, actualMyOptionsEntries_1.size()) << std::string("Expected that combobox MyOptions has 1 entries, but has ") + std::to_string(actualMyOptionsEntries_1.size());
  ...
  void ComboBoxes_ViewTest::then_MyOptions_has_1_entries_and_selected_A_and_is_not_visible()
  {
    ...
    ASSERT_EQ(1, actualMyOptionsEntries_2.size()) << std::string("Expected that combobox MyOptions has 1 entries, but has ") + std::to_string(actualMyOptionsEntries_2.size());

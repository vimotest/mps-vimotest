...
namespace widgetassertions
{
  ...
  void ComboBoxes_ViewTest::then_MyOptions_has_3_entries_and_selected_A1_and_is_enabled_and_is_visible()
  {
    ...
    ASSERT_EQ(3, actualMyOptionsEntries.size()) << std::string("Expected that combobox MyOptions has 3 entries, but has ") + actualMyOptionsEntries.size();
  ...
  void ComboBoxes_ViewTest::then_MyOptionsWithFreeText_has_2_entries_and_and_shows_text_My_Free_Text_()
  {
    ...
    ASSERT_EQ(2, actualMyOptionsWithFreeTextEntries.size()) << std::string("Expected that combobox MyOptionsWithFreeText has 2 entries, but has ") + actualMyOptionsWithFreeTextEntries.size();

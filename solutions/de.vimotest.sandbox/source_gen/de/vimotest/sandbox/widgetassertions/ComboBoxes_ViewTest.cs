...
public class ComboBoxes_ViewTest
{
    ...
    public virtual void then_MyOptions_has_3_entries_and_selected_A1_and_is_enabled_and_is_visible()
    {
        ...
        Assert.AreEqual(3, actualMyOptionsEntries.Count, "Expected that combobox MyOptions has 3 entries, but has " + actualMyOptionsEntries.Count);
    ...
    public virtual void then_MyOptionsWithFreeText_has_2_entries_and_and_shows_text_My_Free_Text_()
    {
        ...
        Assert.AreEqual(2, actualMyOptionsWithFreeTextEntries.Count, "Expected that combobox MyOptionsWithFreeText has 2 entries, but has " + actualMyOptionsWithFreeTextEntries.Count);
        ...
        Assert.AreEqual(null, this.sut.getMyOptionsWithFreeTextComboBoxSelectedEntry(), "Expected that combobox MyOptionsWithFreeText has " + "no selection" + ", but was <" + this.sut.getMyOptionsWithFreeTextComboBoxSelectedEntry() + ">");
    ...
    public virtual void then_MyOptions_has_1_entries_and_selected_A_and_is_not_enabled()
    {
        ...
        Assert.AreEqual(1, actualMyOptionsEntries_1.Count, "Expected that combobox MyOptions has 1 entries, but has " + actualMyOptionsEntries_1.Count);
    ...
    public virtual void then_MyOptions_has_1_entries_and_selected_A_and_is_not_visible()
    {
        ...
        Assert.AreEqual(1, actualMyOptionsEntries_2.Count, "Expected that combobox MyOptions has 1 entries, but has " + actualMyOptionsEntries_2.Count);

...
namespace widgetassertions
{
  ...
  void Labels_ViewTest::then_MultiLine_shows_text_Expected_Line_1_Expected_Line_2_()
  {
    ...
    ASSERT_EQ(2, actualMultiLineLines.size()) << std::string("Expected that label MultiLine has text with 2 lines, but has ") + std::to_string(actualMultiLineLines.size());
  ...
  void Labels_ViewTest::then_WithMultiLineToolTip_shows_text_Info_and_shows_tooltip_Line1_Line2_()
  {
    ...
    ASSERT_EQ(2, actualWithMultiLineToolTipLines.size()) << std::string("Expected that label WithMultiLineToolTip has tooltip with 2 lines, but has ") + std::to_string(actualWithMultiLineToolTipLines.size());

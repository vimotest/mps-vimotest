...
public class Labels_ViewTest
{
    ...
    public virtual void then_MultiLine_shows_text_Expected_Line_1_Expected_Line_2_()
    {
        ...
        Assert.AreEqual(2, actualMultiLineLines.Count, "Expected that label MultiLine has text with 2 lines, but has " + IntegerFunctions.ToString(actualMultiLineLines.Count));
    ...
    public virtual void then_WithMultiLineToolTip_shows_text_Info_and_shows_tooltip_Line1_Line2_()
    {
        ...
        Assert.AreEqual(2, actualWithMultiLineToolTipLines.Count, "Expected that label WithMultiLineToolTip has tooltip with 2 lines, but has " + IntegerFunctions.ToString(actualWithMultiLineToolTipLines.Count));

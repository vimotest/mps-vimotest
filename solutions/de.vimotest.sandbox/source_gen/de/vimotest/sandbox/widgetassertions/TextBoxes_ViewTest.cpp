...
namespace widgetassertions
{
  ...
  {
    EXPECT_EQ(std::string("Some entered Input"), this->sut->getMyValueTextBoxText()) << std::string("Expected that textbox MyValue has text <") + std::string("Some entered Input") + std::string(">, but was <") + this->sut->getMyValueTextBoxText() + std::string(">");
